...
class TrafficAnalysisService:
    ...
    def __init__(self, opts):
        ...
        self.dsort_weight: str = str(
            getattr(self.opts, "dsort_weight", "weights/tracking/deepsort/ckpt.t7")
        )
    ...
    def _extract_plate_text(self, plate_image):
        ...
        if len(results) > 0:
            ...
            if (
                plate_info
                and len(plate_info) > 2
                and plate_info[0].isalpha()
                and plate_info[2] == "C"
            ):
        ...
        if self.read_plate and in_frame_ids:
            ...
            if crops:
                ...
                for idx, det in enumerate(detections):
                    ...
                    v.license_plate_bbox = pxyxy + np.array(
